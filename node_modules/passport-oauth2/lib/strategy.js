...
OAuth2Strategy.prototype.authenticate = function(req, options) {
  ...
  //Merge in new options from authenticate method
  for(attr in options) {
    this._options[attr]=options[attr];
  }

  // Delay construction of the this._oauth so we can support user specific tokenURL urls
  if(!this._oauth) {

      // NOTE: The _oauth2 property is considered "protected".  Subclasses are
      //       allowed to use it when making protected resource requests to retrieve
      //       the user profile.
      this._oauth2 = new OAuth2(this._options.clientID,  this._options.clientSecret,
          '', this._options.authorizationURL, this._options.tokenURL, this._options.customHeaders);
  }
